...
{ 
    private static string connectionString = @"Data Source=..\..\Files\RoomSchedulingSystem.db;Version=3";
    public static void InitializeDatabase()
    {
        if (!File.Exists(@"..\..\Files\RoomSchedulingSystem.db"))
        {
            SQLiteConnection.CreateFile(@"..\..\Files\RoomSchedulingSystem.db");
